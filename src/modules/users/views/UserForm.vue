<template>
    ...
    >
        <v-row>
            ...
            <v-col cols="12" md="6">
                <!-- En edición se deja vacía para no cambiar la contraseña actual. -->
                <AppPasswordInput
...
import { AppInput, AppModal, AppPasswordInput, AppSelect } from 'vuetify-app-kit';
...
async function handleSaveUser() {
    try {
        ...
        // Los errores ya se manejan en el composable.
    }
}
</script>
